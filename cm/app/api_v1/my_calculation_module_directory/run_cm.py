...
def main(heat_density_map, pix_threshold, DH_threshold, output_raster1,
         ...
         search_radius, investment_period, transmission_line_threshold, nuts2_id, output_transmission_lines,
    ...
    total_cost_scalar, total_flow_scalar, total_cost_per_flow = \
        excess_heat(output_shp2, search_radius, investment_period, transmission_line_threshold, nuts2_id, output_transmission_lines)
